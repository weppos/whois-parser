...
describe Whois::Parsers::WhoisNicRe, "status_registered.expected" do
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].updated_on).to eq(Time.parse("2017-07-17 12:40:19 UTC"))
    end
  end
