...
#
#   /spec/fixtures/responses/whois.registration.ge/ge/status_registered.expected
#
...
require 'spec_helper'
require 'whois/parsers/whois.registration.ge.rb'

describe Whois::Parsers::WhoisRegistrationGe, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.registration.ge/ge/status_registered.txt")
  ...
  describe "#domain" do
    it do
      expect(subject.domain).to eq("google.ge")
    end
  end
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2006-07-28"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2022-07-29"))
    end
  end
  describe "#registrar" do
    it do
      ...
      expect(subject.registrar.name).to eq("proservice ltd")
