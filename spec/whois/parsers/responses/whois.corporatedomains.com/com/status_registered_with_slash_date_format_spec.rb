...
#
#   /spec/fixtures/responses/whois.corporatedomains.com/com/status_registered_with_slash_date_format.expected
#
...
describe Whois::Parsers::WhoisCorporatedomainsCom, "status_registered_with_slash_date_format.expected" do

  subject do
    file = fixture("responses", "whois.corporatedomains.com/com/status_registered_with_slash_date_format.txt")
