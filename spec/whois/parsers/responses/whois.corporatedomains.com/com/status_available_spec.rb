...
#
#   /spec/fixtures/responses/whois.corporatedomains.com/com/status_available.expected
#
...
describe Whois::Parsers::WhoisCorporatedomainsCom, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.corporatedomains.com/com/status_available.txt")
