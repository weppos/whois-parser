...
describe Whois::Parsers::WhoisNicFr, "status_registered.expected" do
  ...
  describe "#created_on" do
    it do
      ...
      expect(subject.created_on).to eq(Time.parse("2004-10-25 22:00:00 UTC"))
    end
  end
  describe "#updated_on" do
    it do
      expect(subject.updated_on).to be_a(Time)
      expect(subject.updated_on).to eq(Time.parse("2018-10-25 22:34:00 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2019-10-25 22:00:00 UTC"))
    end
  end
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].updated_on).to eq(Time.parse("2017-07-17 12:40:50 UTC"))
    end
  end
