...
#
#   /spec/fixtures/responses/whois.directnic.com/status_available.expected
#
...
describe Whois::Parsers::WhoisDirectnicCom, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.directnic.com/status_available.txt")
