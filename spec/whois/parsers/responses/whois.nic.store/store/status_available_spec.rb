...
#
#   /spec/fixtures/responses/whois.nic.store/store/status_available.expected
#
...
require 'spec_helper'
require 'whois/parsers/whois.nic.store.rb'

describe Whois::Parsers::WhoisNicStore, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.store/store/status_available.txt")
