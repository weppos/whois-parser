...
#
#   /spec/fixtures/responses/whois.cira.ca/ca/status_available_v3.expected
#
...
describe Whois::Parsers::WhoisCiraCa, "status_available_v3.expected" do

  subject do
    file = fixture("responses", "whois.cira.ca/ca/status_available_v3.txt")
