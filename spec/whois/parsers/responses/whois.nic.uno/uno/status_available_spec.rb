...
#
#   /spec/fixtures/responses/whois.nic.uno/uno/status_available.expected
#
...
require 'spec_helper'
require 'whois/parsers/whois.nic.uno.rb'

describe Whois::Parsers::WhoisNicUno, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.uno/uno/status_available.txt")
