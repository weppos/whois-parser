...
#
#   /spec/fixtures/responses/whois.nic.ge/ge/status_registered.expected
#
...
require 'spec_helper'
require 'whois/parsers/whois.nic.ge.rb'

describe Whois::Parsers::WhoisNicGe, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.nic.ge/ge/status_registered.txt")
