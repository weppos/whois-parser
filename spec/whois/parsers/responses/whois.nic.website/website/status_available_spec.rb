...
#
#   /spec/fixtures/responses/whois.nic.website/website/status_available.expected
#
...
require 'spec_helper'
require 'whois/parsers/whois.nic.website.rb'

describe Whois::Parsers::WhoisNicWebsite, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.website/website/status_available.txt")
