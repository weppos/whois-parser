...
#
#   /spec/fixtures/responses/whois.nic.fun/fun/status_available.expected
#
...
require 'spec_helper'
require 'whois/parsers/whois.nic.fun.rb'

describe Whois::Parsers::WhoisNicFun, "status_available.expected" do

  subject do
    file = fixture("responses", "whois.nic.fun/fun/status_available.txt")
