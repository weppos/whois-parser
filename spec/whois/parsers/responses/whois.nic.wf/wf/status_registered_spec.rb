...
require 'spec_helper'
require 'whois/parsers/whois.nic.wf.rb'

describe Whois::Parsers::WhoisNicWf, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2018-12-31 23:33:39 UTC"))
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].updated_on).to eq(Time.parse("2017-07-17 12:41:18 UTC"))
    end
  end
