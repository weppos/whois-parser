...
#
#   /spec/fixtures/responses/whois.registro.ar/ar/status_registered.expected
#
...
describe Whois::Parsers::WhoisNicAr, "status_registered.expected" do

  subject do
    file = fixture("responses", "whois.registro.ar/ar/status_registered.txt")
